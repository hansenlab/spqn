#'
#' @param cor_mat Matrix, correlation matrix, generated by sorted expression matrix
#' @param ngrp Integer, number of bins to use in the normalization
#' @param size_grp Integer, size of large bin
#' @param ref_grp Integer, the location of reference bin that represents target distribution
