...
We furtherly examined the difference of the distributions using Q-Q plot. We used the bins with the second highest expression level on the diagonal as reference, and compared the distribution with other bins in the diagonal. We observe that the distributions not only differs in the scale, but also in the shape. 
```{r, message = FALSE, fig.width = 4, fig.height = 4}
par(mfrow = c(3,3))
for(j in 1:10){
