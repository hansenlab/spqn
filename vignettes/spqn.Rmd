...
The spqn package contains an implementation of spatial quantile normalization (SpQN) as described in [@spqnPreprint]. This is a method for adjusting for a mean-correlation relationship in a correlation matrix. The main application of this method is in co-expression analysis.
