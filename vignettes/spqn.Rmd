...
Then compare the IQR of correlations between genes in each expression level, by gridding the correlation matrix into 10 by 10 bins, and compute the interquartile ranges (IQRs) for each bin, and plot them (the width of each box).
```{r, message=FALSE}
